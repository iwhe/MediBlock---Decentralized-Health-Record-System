      ...
      >
        ...
        >
          <form className="
            ...
            backgroundColor: "rgb(3, 201, 215)"}}> <h2 style={{padding:'10px',textTransform: "uppercase", fontSize:'1.5rem'}}>Record and Track Every Medical Visit with Professionals:</h2>
            <table 
