  ...
  function showAllergies() {
    if (allergies.length > 0) {
      return allergies[0].map((allergy) => {
        return (
          <tr>
            <td style={{ fontWeight: "bold" }}>{allergy.name}</td>
            <td>{allergy.type}</td>
            ...
            {/* <td>
              <button value="Delete" onClick={() => del(allergy.name)}>
              < MdDeleteForever/>
                </button>
            </td> */}
          </tr>
      ...
      >
        ...
        >
          <form className="
            ...
            >Allergies</h1>
            {/* <h2 style={{padding:'10px',textTransform: "uppercase", fontSize:'1.5rem'}}>Record your allergies:</h2> */}
