            ...
            if (patient.hasOwnProperty('name')) {
                return (
                    <tr style={{fontSize: 'larger'}}>
                        ...
                        <td>{patient.mail}</td>
                        <td >
                            <input style={{ backgroundColor:'rgb(3, 201, 215)', padding:'12px 23px', border:'1px solid red', borderRadius:'41px',color: 'honeydew',}}
                             type="button" value="View" onClick={() => view(patient.hash)} />
                        </td>
                        <td>
                            <input style={{ color:'rgb(25 184 0)', fontSize:'20px', textDecoration:'underline'}}
                            type="button" value="Treated" onClick={() => treated(patient.hash)} />
                        </td>
                    </tr>
